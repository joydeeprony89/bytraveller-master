...
namespace ByTraveller.EntityFramework.Migrations
{
    ...
    [Migration("20190601122507_Updated model and mapping")]
    partial class Updatedmodelandmapping
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ByTraveller.Model.Models.Card", b =>
                {
                    b.HasOne("ByTraveller.Model.Models.Image", "Image")
                        .WithMany()
                        .HasForeignKey("ImageId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ByTraveller.Model.Models.SubMenuItem", "SubMenuItem")
                        .WithMany("Cards")
